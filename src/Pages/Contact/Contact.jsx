...
const Contact = () => {
  const [activeQuestion, setActiveQuestion] = useState(null);
  const [isFormOpen, setIsFormOpen] = useState(false);
  const [archiveYearFilter, setArchiveYearFilter] = useState(''); // for filtering archive by year
  ...
  // Current team (2024–2025 assumed)
  const currentTeam = [
    {
      "designation": "Director",
      "name": "Professor Dr. Kazi Masudul Alam",
  ...
  // Archive / Past Executives (sample data — expand as needed)
  const archiveMembers = [
    // 2023
    { designation: "President", name: "Md. Rakibul Hasan", student_id: "190215", image_url: "https://via.placeholder.com/300x400?text=2023", year: "2023" },
    { designation: "General Secretary", name: "Sumaiya Akter", student_id: "190230", image_url: "https://via.placeholder.com/300x400?text=2023", year: "2023" },
    { designation: "Treasurer", name: "Fahim Shahriar", student_id: "190198", image_url: "https://via.placeholder.com/300x400?text=2023", year: "2023" },

    // 2022
    { designation: "President", name: "Sadia Afrin", student_id: "180245", image_url: "https://via.placeholder.com/300x400?text=2022", year: "2022" },
    { designation: "Vice President", name: "Asif Mahmud", student_id: "180210", image_url: "https://via.placeholder.com/300x400?text=2022", year: "2022" },

    // 2021
    { designation: "President", name: "Md. Imran Hossain", student_id: "170189", image_url: "https://via.placeholder.com/300x400?text=2021", year: "2021" },
    { designation: "General Secretary", name: "Nusrat Jahan", student_id: "170233", image_url: "https://via.placeholder.com/300x400?text=2021", year: "2021" },
  ];

  // Filter archive by year
  const filteredArchive = archiveMembers.filter(member =>
    !archiveYearFilter || member.year === archiveYearFilter
  );
  ...
  return (
    <div className="relative overflow-hidden font-sans min-h-screen">
      ...
      {/* Archive / Past Executives */}
      <motion.section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Archive — Past Executives</h2>
            <p className="text-gray-600 mb-8">
              Previous leadership teams that shaped CLUSTER over the years
            </p>
            ...
            <div className="max-w-xs mx-auto mb-10">
              ...
              >
                ...
                {/* Add more years as you have data */}
              </select>
            </div>
          </div>
          ...
          {filteredArchive.length > 0 ? (
              ...
              {filteredArchive.map((member, i) => (
                ...
                >
                  <div className="text-center">
                    <div className="w-32 h-32 mx-auto mb-4 rounded-full overflow-hidden border-4 border-blue-100 bg-gray-100">
                      <img
                        src={member.image_url}
                        alt={member.name}
                        className="w-full h-full object-cover"
            ...
            <div className="text-center py-16 text-gray-500 text-xl">
              No archive members found for the selected year.
            </div>
          )}
        </div>
      </motion.section>
            ...
            >
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white">
                <div className="flex justify-between items-start">
                  ...
                  <button onClick={() => setIsFormOpen(false)} className="p-2 rounded-full hover:bg-black/10">
                    ✕
                  </button>
                </div>
              </div>
              ...
              <form className="p-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input type="text" placeholder="Batch (Optional)" className="w-full p-3 border rounded-lg" />
