// // src/components/BlogSubmissionForm.jsx
...
//   // const createBlog = (data) => api.post('blogs/', data);
...
//         icon: 'success',
//         title: 'Submitted!',
//         text: 'Your blog post has been submitted and is pending review.',
//         timer: 4000
//       });
...
//                 />
//                 <label htmlFor="restricted" className="text-sm text-gray-700 cursor-pointer">
...
//                   className="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-700 text-white font-medium rounded-lg shadow-md flex items-center justify-center disabled:opacity-60"
