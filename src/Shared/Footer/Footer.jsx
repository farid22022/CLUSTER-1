           ...
           <div className='flex items-center w-fit gap-4 mb-6'>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <a href="mailto:cluster@cseku.ac.bd" className="hover:text-blue-400 transition-colors">
                  cluster@cseku.ac.bd
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-300">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-4">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-all duration-300 hover:scale-110 hover:shadow-lg"
              ...
              <p className="text-sm text-gray-400">
                Follow us for updates on research, events, and opportunities.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-gray-400 text-sm">
              © {currentYear} CLUSTER, Khulna University. All rights reserved.
            </div>
